# Settlements
Settlements represent the efforts of players to inhabit and expand their influence throughout the world. They are meant to provide players and their characters with a connection to the land, while also providing mechanical benefits and customization options for the very world in which the server operates. 
...
Whenever a settlement is upgraded to the next tier, the settlement owner must assign an additional feat to it. Players create their own feats for settlements. 

Below you'll find guidelines and examples of feats at each tier, but is by no means meant to limit your creativity in making your settlement something special. You can choose from any in the list, or make up a new feat that will be added to the list. 
...
## Outpost Feats
A settlement of the Outpost tier has a terrain feat. Discuss what kind of terrain your settlement is in with a Dungeon Master before creating your new feat.

Some example terrain feats are as follows:

| Name | Advantage | Disadvantage |
|:-----|:----------|:-------------|
| Desert Oasis | Attracts anyone wandering the desert, trade is more effective for this settlement (Establishment is available at Outpost tier) | Must get almost all their food through trading |
...
| Holy Ground | Settlement is sanctified in the name of a specific god (Monastery, Temple, Grove are available at Outpost tier) | Monastery, Temple and Grove strongholds here can only be dedicated to that god |
...
| Consecrated Ground | A cleric's ability to turn undead near this settlement is enhanced. Any undead creature in the vicinity is weakened and more vulnerable to magical effects. Undead are unable to be created or summoned here. | Due to the consecrated ground blessed by [name of god], other gods cannot be channeled while in Moonrest. If a cleric or paladin attempts to channel through their god, their holy symbol or spell casting focus does not work. If the god worshipped is another member of [that god's pantheon], then the channeling will still work, but at disadvantage. |
| Make Your Own |  |  |
...
| Moonrest (Faith/Tradition) | There are five holy sites in other locations. Once all of these sites have been restored and consecrated, they may be used to travel between Moonrest and that specific location instantaneously (travel costs are free). | When such a desecrated site is attempted to be cleansed, the forces that taint it will retaliate with deadly force. <br/>This settlement and any cleansed site will occasionally attract cultists and attackers intending to desecrate it. |
| Make your own | |


## Town Feats
Once a Village grows into a Town, the improvements to its infrastructure and defenses make it a force to be reckoned with. The influence of the settlement's feats is no longer limited to just the Town. The controller of the settlement creates a feat to represent their Town effect on the lands around it with an additional feat.
...
Perhaps your's is a Citystate with a fearsome army, making military alliances with its neighbors or extorting them for tribute. Perhaps your Citystate is known for wealth and influence, princes and princesses from faraway nations come begging to marry into the ruling class for the prestige alone. Perhaps your Citystate is home to unparalleled innovations, guilds of inventors creating wonders found nowhere else, or powerful mages train future generations of arcane experts to serve the Citystate.
