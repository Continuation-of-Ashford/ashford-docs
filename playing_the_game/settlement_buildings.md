...
:----------------------------------|:------------|------------:|:--------|
| **Trade Post**                   | 1,000       |           4 | Capital building for tier 0. <br/>Generates 250 gold/session for quest rewards. <br/>This building allows purchasing rations and the various [Equipment Packs](https://5e.tools/book.html#phb,5,equipment%20packs,0). <br/><br/> This building does not cost a building slot and is upgraded into the capital building for the next tier. |
| Alchemist's Shack                | 500         |           2 | Allows purchase of healing potions up to the tier of the settlement. (i.e., allows you to purchase regular healing potions at this tier and superior healing potions in a Tier 3 Town settlement) |
| Farm/Fishery/Orchard/etc.`*`     | 500         |           2 | Required to upgrade to tier 1.<br/><br/> Work downtime at this building adds 5 to your roll, when working using the Animal Handeling, Athletics or Nature skills. |
| Wooden Shelter/Housing          | 0           |           2 | Allows characters to long rest without risk at this settlement. <br/><br/> This building does not cost a building slot. It starts out as a cabin or shack, but each time the settlement upgrades a tier after your house is built, your house gets fancier. |
...
|                                  | Gold Cost   |   Downtimes | Effect |
|:---------------------------------|:------------|------------:|:-------|
| **Village Hall**                     | 5,000       |           6 | Capital building for tier 1. <br/>Allows purchasing of any goods craftable in buildings in this Settlement. <br/><br/> This building does not cost a building slot and is upgraded into the capital building for the next tier.|
| Arcane supply shop               | 3,000       |           3 | Allows purchase of spell components. This is the only location you can acquire components with a listed cost (outside of quest rewards and in-session DM fiat). It also sells Component Pouches and components without a cost for 1 gold per component. |
...
| Tier 1 Arena | 10,000 | 4 | Allows Arena Sessions to be held in this settlement.  These sessions are generally shorter combat sessions that are free of permenent consequences (death, fatal injury, etc.) in exchange for lesser rewards. This arena can host fights against creatures of CR 0-10. Multiply the gold rewards from the pit fighting downtime at this city by 1.1 | 
...
| Arcane Scribe                    | 10,000      |           8 | Allows crafting magical items [created with ink](#tier-4-citystate "tattoos, tomes, runes and manuals") up to rare quality. <br/>Scrolls can be crafted in half the time and cost it would usually require your character (including costly spell components).  |
| Steel enchanter                  | 12,000      |           5 | Allows crafting magical [weapons and armor](#tier-4-citystate "Unlike the name implies, this includes wooden items like shields, clubs, bows and arrows, and leather items like light armor, boots and bracers. As well as the metal armors, helms, gauntlets and weapons you'd expect. This also includes enchanting seige weapons for your ship or spelljammer.") up to rare quality.   |
| Luxury enchanter                 | 8,000       |           5 | Allows crafting magical [clothing](#tier-4-citystate "not armor, helms or gauntlets, but anything else like: cloaks, robes, boots, gloves, belts and bracers"), musical instruments, [jewelry and art](#tier-4-citystate "amulets, rings, crowns, bracelets, signets, carpets, insignias, figurines, crystals, stones and gems") and  up to rare quality.  |
| Arcane Laboratory                | 8,000       |           5 | Allows crafting magical consumables, wands, orbs, staves, as well as [tools and miscellaneous objects](#tier-4-citystate "like: brooms, clocks, mirrors, candles, dice, vehicles, chests, tankards, vials and jugs") up to rare quality |
| Engineering Guild`*`               | 14,000      |           5 | Reduces cost of building all other buildings of Citystate tier and below by 20% (limit 1/town).<br/><br/> Work downtime at this building adds 8 to your roll, when working using the Investigation or History skill and Calligrapher's or Painter's Supplies.   |
...
| Tier 2 Arena | 20,000 | 6 | Requires and replaces the Tier 1 arena. This arena can host fights against creatures of CR 0-15. Multiply the gold rewards from the pit fighting downtime at this city by 1.2 | 
...
| Tier 3 Arena | 30,000 | 12 | Requires and replaces the Tier 2 arena. This arena can host fights against creatures of CR 0-20. Multiply the gold rewards from the pit fighting downtime at this city by 1.3 | 
| Master Arena Wards | 10,000 | 6 | Requires and replaces the Tier 3 arena. Allows the arena to host fights against creatures of any CR. Multiply the gold rewards from the pit fighting downtime at this city by 1.4 | 
