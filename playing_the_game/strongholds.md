...
### Benefits
Settlements provide benefits available to all players in a settlement (Demesne Effect and Extended Rest), as well as owner-specific benefits called Class Feature Improvements that are activated on an Extended Rest downtime action.
...
## Demesne effect
An establishment doesn't add a feat to the settlement it is constructed in, it instead enables or changes a downtime of your choice in that settlement. Usually this is the Work Downtime with 4 skill or tool proficiencies of your choice. However you might instead choose to have your Establishment provide a place players can use the Pit Fighting or Gambling downtimes.
