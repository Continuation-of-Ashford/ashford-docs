...
The banner can either be affixed to a polearm, used as a shield, or used as a cape.
 - While used as a shield, its shield bonus to AC equals half your proficiency bonus. 
...
- If you have the Sneak Attack feature, you may bring Scout Legionnaires.

### We are Legion
Also at 21st level, *your soul and the soul of every member of your legion is bound to the banner.* So long as the banner is not destroyed, souls bound to it cannot be trapped or destroyed in a way that would prevent resurrection.

If you are dead, any willing humanoid trained at your stronghold can use the banner using the Activate Magic Item action to *"become the Legendary Commander"*. The humanoid must concentrate on this ability like a spell until the start of its next turn. After the start of its next turn, their ideals, bonds, flaws, character traits, proficiencies, ability scores, and non-racial features are replaced by yours and you take control of that humanoid.  This functions similar to the Reincarnate spell, but instead of creating a new body, the humanoid activating the item gives up their body for you to inhabit.
...
* ***Charge!***    
Pick a number of allies up to your proficiency bonus. They can use their reaction to move up to their speed without provoking attacks of opportunity, then make a melee attack.
* ***Bombard!***   
Pick one or two allies. They can use their reaction to take the attack action with a ranged weapon or cast an evocation spell of 4th level or lower.
* ***On your feet!***   
...
At 24th level, you gain a [Blessing](blessings.md).
...
**Armor Class** 10 (Unarmored)<br>
**Hit Points** 25 + Your maximum hit points divided by the number of legionnaires you have<br>
**Speed** 30
<hr>
...
**Skills** Your skill proficiencies<br>
**Saving Throws** Your saving throw proficiencies<br>
**Languages** Your languages <br>
**Challenge** -
...
**Skills** Your skill proficiencies and expertise<br>
**Saving Throws** Your saving throw proficiencies<br>
**Langauges** Your languages <br>
**Challenge** -
<hr>
